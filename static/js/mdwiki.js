        ...
        var Wiki = (function () {
            ...
            Wiki.prototype.registerFetchConfigAndNavigation = function () {
                ...
                $.md.stage('init').subscribe(function (done) {
                    $.when(MDwiki.Core.Resource.fetch('config.json'), MDwiki.Core.Resource.fetch('navigation.md')).then(function (config, nav) {
...
(function($) {
    ...
    function load_mathjax($links, opt, ref) {
        ...
        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src  = $.md.prepareLink('https://cdn.bootcss.com/mathjax/3.0.5/es5/tex-mml-chtml.js');
